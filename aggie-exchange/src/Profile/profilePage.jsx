...
const ProfilePage = () => {
    const sessionObjects = JSON.parse(sessionStorage.getItem("sessionObject"));
    console.log("SESSIONOBJECT:", sessionObjects);
    if (sessionObjects != null) {
        ...
        return(
            <div style={StyleSheet.container}>
                <h1 style={style.title}> Welcome, {username}!</h1>
                <div style={style.section}>
                    <h2 style={style.sectionTitle}>Update Username</h2>
                    <div style={styles.form}>
                        <input
                            ...
                            style={styles.input}
                            />
                            {errorUsername.value ? <p style={{color:"green", fontSize: 16, textAlignd: "center"}}>{errorUsername.message}</p> : null}
